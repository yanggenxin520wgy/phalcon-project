<?php
namespace @@namespace@@\Modules\Base\Tasks;

use Phalcon\Paginator\Adapter\NativeArray;
use @@namespace@@\Core\PhalBaseService;

class MainTask extends \Phalcon\Cli\Task
{

    /**
     * @var \@@namespace@@\Core\PhalBaseLogger
     */
    protected $logger;
    ...
    public function initialize()
    {
        ...
        [,$this->_dict]     = PhalBaseService::setLanguage($this->locale);
    }
