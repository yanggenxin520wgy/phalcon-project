...
class Color
{
    ...
    {
        $msg = 'Error: ' . $msg;
        $space = mb_strwidth($msg) + 4;
        $out  = static::colorize(str_pad(' ', $space), Color::FG_RED, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
        $out .= static::colorize('  ' . $msg . '  ', Color::FG_RED, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
        $out .= static::colorize(str_pad(' ', $space), Color::FG_RED, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
    ...
    public static function success($msg)
    {
        $msg = 'Success: ' . $msg;
        $space = mb_strwidth($msg) + 4;
        $out  = static::colorize(str_pad(' ', $space), Color::FG_GREEN, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
        $out .= static::colorize('  ' . $msg . '  ', Color::FG_GREEN, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
        $out .= static::colorize(str_pad(' ', $space), Color::FG_GREEN, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
    ...
    public static function info($msg)
    {
        $msg = 'Info: ' . $msg;
        $space = mb_strwidth($msg) + 4;
        $out  = static::colorize(str_pad(' ', $space), Color::FG_BLUE, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
        $out .= static::colorize('  ' . $msg . '  ', Color::FG_BLUE, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
        $out .= static::colorize(str_pad(' ', $space), Color::FG_BLUE, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
    ...
    public static function warning($msg)
    {
        $msg = 'warning: ' . $msg;
        $space = mb_strwidth($msg) + 4;
        $out  = static::colorize(str_pad(' ', $space), Color::FG_YELLOW, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
        $out .= static::colorize('  ' . $msg . '  ', Color::FG_YELLOW, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
        $out .= static::colorize(str_pad(' ', $space), Color::FG_YELLOW, Color::AT_BOLD, Color::BG_BLACK) . PHP_EOL;
